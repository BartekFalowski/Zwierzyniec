...
@section('content')
    ...
    <div class="masthead">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Twoje dane <u>{{$user->name}} {{$user->surname}}</u></h2>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            <form action="{{route('user.update', ['id' => $user->id])}}" method="POST">
                ...
                <br />
                <button class="btn btn-primary btn-xl" type="submit">Zapisz dane</button>
                <a href="{{route('signout')}}" role="button" class="btn btn-danger btn-xl">Wyloguj</a>
            </form>
        </div>
    </div>
